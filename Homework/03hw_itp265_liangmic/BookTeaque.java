...
public class BookTeaque
{
	...
	String nameInput = sca.nextLine();
	System.out.println("What's your card number?");
	String cardNumInput = sca.nextLine();
	System.out.println("What's your CVV?");
	String cvvInput = sca.nextLine();
	
	currentCustomer = new Customer(nameInput,cardNumInput,cvvInput);
    }
    ...
    public void shop(){
        ...
        System.out.println("You paid " + currentCustomer.getBalance());
    }
    
    public static void main(String[] args){
	BookTeaque myStore = new BookTeaque();
	myStore.askCustomerInfo();
	myStore.shop();
}
}
